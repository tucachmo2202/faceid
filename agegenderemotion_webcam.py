...
import cv2
import datetime
from faceid.detector import FaceDetectorModels, FaceDetector
from faceid.encoder  import FaceEncoderModels, FaceEncoder
from faceid.pose import FacePoseEstimatorModels, FacePoseEstimator
from faceid.age import FaceAgeEstimatorModels, FaceAgeEstimator
from faceid.gender import FaceGenderEstimatorModels, FaceGenderEstimator
from faceid.emotion import FaceEmotionEstimatorModels, FaceEmotionEstimator
...
def main(args):
    ...
    resolutions = [ RESOLUTION_VGA, RESOLUTION_VGA, RESOLUTION_HD, RESOLUTION_FULLHD ]
    try:
